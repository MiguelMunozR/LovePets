...
<div class="row">
  ...
  <div class="card-header">
   <h2>ADMINISTRADOR DE PROVEDOR</h2>
  </div>

  <div class="card-body">

      <span class="btn bg-dark"style="color: white;"  data-toggle="modal" data-target="#exampleModalProvedor">Registrar provedor</span>
      ...
      <div id="DataTableproductos">
        <?php require_once ('Public/Tablas/tbl_provedor.php');?>
      </div>
...
<?php
require_once 'public/formularios/form_provedor.php';
