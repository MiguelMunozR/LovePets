...
<div class="row">
  ...
  <div class="card-body">
      ...
      <span class="btn bg-dark"style="color: white;"  data-toggle="modal" data-target="#exampleModalProducto">Registrar producto</span>
      ...
      <div id="DataTableproductos">
        <?php require_once ('Public/Tablas/tbl_productos.php');?>
      </div>

<?php
require_once 'public/formularios/form_productos.php';
?>
</div>
</div>
</div>
