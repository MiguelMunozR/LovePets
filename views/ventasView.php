...
<div class="row">
  ...
  <div class="card-body">
      <span class="btn bg-dark"style="color: white;"  data-toggle="modal" data-target="#exampleModalVenta_producto">Registrar ventas</span>
      <hr>
      <div id="DataTableusuarios">
        <?php require_once ('Public/Tablas/tbl_venta_producto.php');?>
      </div>
</div>
</div>
</div>
<?php
require_once 'public/formularios/form_venta_producto.php';
?>
