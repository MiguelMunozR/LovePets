...
<div class="row">
  ...
  <div class="card-body">
      <span class="btn bg-dark"style="color: white;" data-toggle="modal" data-target="#exampleModal">Registrar usuario</span>
       <span class="btn bg-dark"style="color: white;"  data-toggle="modal" data-target="#registroTipo"> actualizar tipo de usuario</span>
      <hr>
      <div id="DataTableusuarios">
        <?php require_once ('Public/Tablas/tbl_usuario.php');?>
      </div>
</div>
</div>
</div>
...
require_once 'public/formularios/form_tipoUsuario.php';
